...
public class Dogs extends JFrame {
	...
	private static final String connStr = "jdbc:postgresql://yacata.dcs.gla.ac.uk:5432/lev3_14_2025138w"; 
	...
	private Dogs() {
		...
		String ownerCount = "select owner.ownerid, COUNT(dog.ownerid) as noOfDogs " +
				"from owner, dog " + 
