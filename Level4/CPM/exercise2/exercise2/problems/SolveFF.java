...
public class SolveFF {
	...
	public SolveFF(String filename) throws IOException {
	...
	public void postHeuristic() {
		...
		IntStrategy ff = ISF.custom(new FirstFail(), valueSelector, meetingTimes);
		solver.set(ff);
	}
	...
	public static void main(String[] args) {
		...
		if (args.length == 1) {
			try {
				SolveFF solution = new SolveFF(args[0]);
